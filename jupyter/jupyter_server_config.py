...
#  password.
#  Default: ''
c.ServerApp.password = 'argon2:$argon2id$v=19$m=10240,t=10,p=8$EYn4kCKYXNoMbDRKNRkPdQ$BDkRLTnaGBJDM2ZAIRObOdH/sHiRP6JNO37kH7DIix0'
...
#  Choices: any of ['sha3_256', 'sha3_384', 'sha384', 'sha256', 'sha224', 'sha3_512', 'sha3_224', 'sha1', 'blake2s', 'md5', 'sha512', 'blake2b']
#  Default: 'sha256'
